    ...
    <div className='h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
      ...
      />
          <div className="p-4 relative z-10 w-full text-center">
              ...
              Embark on a musical journey to unlock your full potential with expert guidance. Explore melodies, rhythms, and harmonies to master the art of music. Let your passion soar with our resources. Start your musical odyssey today!
              </p>
              <div className='mt-4'>
                  <Link href={'/courses'}>
